...
export class BaseMatcher {
   ...
   */
  doesSegmentMatch(
    _segment: import("./path.js").JSONSegmentPathEncodedType | null,
...
export class AnyMatcher extends BaseMatcher {
   ...
   */
  doesSegmentMatch(
    _segment: import("../lib/path.js").JSONSegmentPathEncodedType,
    _parentLastPossibleMatch: boolean,
  ): boolean
}
/**
...
export class SegmentMatcher extends BaseMatcher {
   ...
   */
  constructor(
    segmentMatch: import("../lib/path.js").JSONSegmentPathType,
   ...
   */
  doesSegmentMatch(
    segment: import("../lib/path.js").JSONSegmentPathEncodedType,
