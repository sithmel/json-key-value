 ...
 * @returns {number}
 */
export function getCommonPathIndex(oldPath: JSONPathType, newPath: JSONPathType): number;
/**
 ...
 * @returns {boolean}
 */
export function isPreviousPathInNewPath(oldPath: JSONPathType, newPath: JSONPathType): boolean;
/**
