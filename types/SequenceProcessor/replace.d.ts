 ...
 */
export default function replace(asyncIterable: AsyncIterable<Iterable<[Path, Value, number?, number?]>>, path: Path, value: Value): AsyncIterable<Iterable<[Path, Value, number?, number?]>>;
