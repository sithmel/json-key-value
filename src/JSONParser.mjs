...
import { ParsingError, isWhitespace, addTrailingSpace } from "./utils.mjs"
/**
...
export default class JSONParser {
   ...
   */
  async *parse(chunks) {
    // a trailing space is a trick to have something like "100" work,
    // otherwise is not possible to know a number is complete
    for await (const chunk of addTrailingSpace(chunks)) {
